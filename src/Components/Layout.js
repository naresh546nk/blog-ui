...
const Layout = ({ headerHeight, footerHeight }) => {
    ...
    const { getAllBlogs, getAllCategories, blogList, isLoading, showYourBlogs, showOthersBlogs, myBlogsCounts, othersBlogsCounts,
        findBlogsByCategoryAndDateRange, blogCategories
    ...
    const [changeInputTypeForStartDate, setChangeInputTypeForStartDate] = useState(false);
    const [changeInputTypeForEndDate, setChangeInputTypeForEndDate] = useState(false);
    ...
    const searchHandler = () => {
        ...
        const parms = { category, startDate: formatedStartDate, endDate: formatedEndDate }
        console.log(parms)
        ...
        <Container>
            ...
            >
                ...
                <Col sm={{ span: 9, offset: 3 }} className="d-flex flex-column w-95">
                    <Pages headerHeight={headerHeight} footerHeight={footerHeight} />               </Col>
